	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($con, "UPDATE empleados SET nombres='$nombres', apellidos='$apellidos', cargo='$cargo', email='$email', tel_personal='$tel_personal', puesto='$puesto', estado='$estado', ext='$ext' WHERE codigo='$nik'") or die(mysqli_error());
				if($update){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="cargo" value="<?php echo $row ['cargo']; ?>" class="input-group date form-control" date="" data-date-format="yyyy-mm-dd" placeholder="0000-00-00" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Email</label>
					<div class="col-sm-3">
						<textarea name="email" class="form-control" placeholder="Email"><?php echo $row ['email']; ?></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Tel. Personal</label>
					<div class="col-sm-3">
						<input type="text" name="tel_personal" value="<?php echo $row ['tel_personal']; ?>" class="form-control" placeholder="Teléfono" required>
					</div>
				</div>
                <div class="form-group">
					<label class="col-sm-3 control-label">Ext</label>
					<div class="col-sm-3">
						<input type="text" name="ext" value="<?php echo $row ['ext']; ?>" class="form-control" placeholder="Extencion" required>
					</div>
				</div>
				<div class="form-group">
